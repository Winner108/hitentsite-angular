...
export class CasinoComponent implements OnInit {
  ...
  getCategories(): void {
    this.api.gameCategory(Globals.TYPE_SLOT).subscribe(data => {
  ...
  getProviders(): void {
    this.api.gameProvider(Globals.TYPE_SLOT).subscribe(data => {
  ...
  getGames(): void {
    this.api.games(Globals.TYPE_SLOT, this.search).subscribe(data => {
  ...
  playGame(id: number | undefined, name: string | undefined): void {
    ...
    {
      this.router.navigate(['/games/playgame/casino/' + id])
      return;
    }
